...
SELECT first_name, last_name, hire_date, DATEDIFF(CURDATE(), hire_date)/365 AS years_at_company FROM employees WHERE hire_date LIKE '199%' AND birth_date LIKE '%12-25';

-- Find the smallest and largest current salary from the salaries table.
SELECT MAX(salary) FROM salaries; -- Max is 158,220 / Min is 36,623
